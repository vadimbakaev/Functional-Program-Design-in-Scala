...
$c_Lcalculator_Calculator$.prototype.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D = (function(resolved, toResolve, references) {
  _evalWithHistory: while (true) {
    var x1 = toResolve;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      if (resolved.contains__O__Z(toResolve)) {
        return (NaN)
      } else {
        var temp$resolved = $as_sci_Set(resolved.$$plus__O__sc_Set(toResolve));
        var temp$toResolve = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
        resolved = temp$resolved;
        toResolve = temp$toResolve;
        continue _evalWithHistory
      }
    } else if ($is_Lcalculator_Plus(x1)) {
      var x4 = $as_Lcalculator_Plus(x1);
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(resolved.$$plus__O__sc_Set(toResolve)), a, references) + this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(resolved.$$plus__O__sc_Set(toResolve)), b, references))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(resolved.$$plus__O__sc_Set(toResolve)), a$2, references) - this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(resolved.$$plus__O__sc_Set(toResolve)), b$2, references))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(resolved.$$plus__O__sc_Set(toResolve)), a$3, references) * this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(resolved.$$plus__O__sc_Set(toResolve)), b$3, references))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(resolved.$$plus__O__sc_Set(toResolve)), a$4, references) / this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(resolved.$$plus__O__sc_Set(toResolve)), b$4, references))
    } else {
      throw new $c_s_MatchError().init___O(x1)
    }
  }
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  if ($is_Lcalculator_Literal(expr)) {
    ...
    return this.evalWithHistory__sci_Set__Lcalculator_Expr__sci_Map__D($as_sci_Set(jsx$1), expr, references)
  }
});
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2) {
    return (function() {
      var delta$1 = $uD($m_Lcalculator_Polynomial$().computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a$2, b$2, c$2).apply__O());
      if ((delta$1 < 0)) {
        var array = [0.0];
        if (($uI(array.length) === 0)) {
          var jsx$1 = $m_sci_Set$EmptySet$()
        ...
        var bv = $uD(b$2.apply__O());
        var av = $uD(a$2.apply__O());
        var array$1 = [((((-bv) + $uD($g.Math.sqrt(delta$1))) / 2) * av), ((((-bv) - $uD($g.Math.sqrt(delta$1))) / 2) * av)];
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(tweetText$1) {
    return (function() {
      ...
      var jsx$1 = $as_T(tweetText$1.apply__O());
      var thiz = $as_T(tweetText$1.apply__O());
      return ((140 - jsx$2.codePointCount__T__I__I__I(jsx$1, 0, $uI(thiz.length))) | 0)
    })
  })(tweetText));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_sjsr_RuntimeString$.prototype.codePointCount__T__I__I__I = (function(thiz, beginIndex, endIndex) {
  if ((((endIndex > $uI(thiz.length)) || (beginIndex < 0)) || (endIndex < beginIndex))) {
    throw new $c_jl_IndexOutOfBoundsException().init___()
  };
  var res = ((endIndex - beginIndex) | 0);
  var i = beginIndex;
  var end = (((-1) + endIndex) | 0);
  while ((i < end)) {
    var index = i;
    var high = (65535 & $uI(thiz.charCodeAt(index)));
    var index$1 = ((1 + i) | 0);
    var low = (65535 & $uI(thiz.charCodeAt(index$1)));
    if ((((64512 & high) === 55296) && ((64512 & low) === 56320))) {
      res = (((-1) + res) | 0)
    };
    i = ((1 + i) | 0)
  };
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    return new $c_T2().init___O__O(key, new $c_Lcalculator_Signal().init___F0(expr$2))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
